...
public class RandomWords {
  ...
  public RandomWords() throws IOException {   
    try (BufferedReader reader = Files.newBufferedReader(Paths.get("res", "words.txt"))) {
      // YOUR CODE HERE
  ...
  public List<String> createList(int listSize) {
    ...
    // YOUR CODE HERE
    List<String> wordList = new Random().ints(listSize, 0, sourceWords.size())
          .mapToObj(sourceWords::get).collect(Collectors.toList());
